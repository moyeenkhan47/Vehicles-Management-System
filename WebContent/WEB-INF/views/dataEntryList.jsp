...
<link href="${pageContext.request.contextPath}/vendor/datatableJsCss/css/buttons.dataTables.min.css"
	rel="stylesheet">
	<link href="${pageContext.request.contextPath}/css/dataentry.css"
	rel="stylesheet">
</head>
<body>
			...
			<div class="col-lg-12" style="margin-left: 14px;">
				<div class="panel panel-default">
					...
					<div class="panel-heading">
						<h3 id="siteh3">Entries</h3>
						<span style="color: green;text-align: center;display:inline-block;margin-left:25%;">${message}</span>

					<a  class="btn btn-primary btn-lg pull-right" id="pbtn" 
						href="${pageContext.request.contextPath}/dataEntry/addDataEntry.do">Add Entry</a>
					</div>
					...
					<div class="panel-body" >
						<div class="table-responsive" style="overflow-x: initial;">
							<table id="myDatatable"	class="display table table-bordered table-striped table-hover">
								<thead>
									<tr>
									    <th class="idwidth"><span class="spn">Challan No.</span></th>
									    <th class="idwidth"><span class="spn">Vendor</span></th>
										<th class="datewidth"><span class="spn">Entry Date</span></th	>							
										<th class="namewidth"><span class="spn">Site</span></th> 
										<th class="vtypewidth"><span class="spn">Vehicle Type</span></th>
										<th class="vnumber"><span class="spn" >Vehicle No.</span></th>
									
										<!-- <th><span class="spn">Time</span></th> -->
										...
										<th><span class="spn">&nbsp;&nbsp;<i class="fa fa-inr"></i><br>Rate</span></th>
										 <th class="spns"><span class="spn">&nbsp;&nbsp;&nbsp;&nbsp;K.m<br>Distance&nbsp;</span></th>
										<!--<th><span class="spn">Diesel</span></th> -->
										
										<th><span class="spn">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-inr"></i><br>Expense </span></th> 
										<!-- <th><span class="spn">Remarks</span></th> -->
										<!-- <th>Role</th>									
									    <th>Site</th>-->
										<th style="display:none">Expenses</th>
										<th class="idwidth"><span class="spn">Action</span></th> 
									</tr>
								</thead>
								<tbody>
									<c:forEach items="${dataEntryList}" var="dataEntry" varStatus="i" >
										...
										<td> 
										<fmt:formatDate pattern = "dd-MMM-yyyy" value = "${dataEntry.entryDate}" /></td>
											...
											<%-- <td><c:out value="${dataEntry.hours}:${dataEntry.minutes}" /></td>
										 --%>
										 <%-- <td><c:out value="${dataEntry.loading}" /></td>
										 <td><c:out value="${dataEntry.unloading}" /></td>  --%>
										 <td style="text-align:right;">
										 <fmt:setLocale value = "en_IN"/>
                                         <fmt:formatNumber  type = "number" maxFractionDigits = "2" value = "${dataEntry.rate}"  />&nbsp;
										</td>
										  <td style="text-align:right;">
										 <c:if test="${dataEntry.distance!=''}">
										 <c:out value="${dataEntry.distance}" />&nbsp;
										 </c:if>
										 </td>
										 <%--<td>
										 <c:if test="${dataEntry.diesel!=''}">										 
										 <c:out value="${dataEntry.diesel}" />&nbsp;ltr
										 </c:if>
										 </td> --%>
			           		              <td style="text-align:right;">
										 ...
										 <input type="hidden" id="inphidden_${i.index+1}" value="${dataEntry.dataEntryId}"  />
										 </td> 
										 <td style="display:none"><c:out value="${dataEntry.expense}" />&nbsp;</td>
										 <%-- <td><c:out value="${dataEntry.remarks}" /></td>  --%>
											<%--  <td><a class="btn btn-primary" data-toggle="modal" data-target="#myModal"
												href="${pageContext.request.contextPath}/dataEntry/viewDataEntry/${dataEntry.dataEntryId}.do">View</a>&nbsp;&nbsp;
												<!-- <td>
												 <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Open Modal</button>
												</td>
												
												<td> --><a class="btn btn-primary"
												href="${pageContext.request.contextPath}/dataEntry/editDataEntryById/${dataEntry.dataEntryId}.do">Edit</a>&nbsp;&nbsp;
												<a class="btn btn-primary"
												href="${pageContext.request.contextPath}/dataEntry/deleteDataEntryById/${dataEntry.dataEntryId}.do"
												onclick="return confirm('Are you sure?')">Delete</a></td>  --%>
												
												<td><a class="btn1" data-toggle="modal" data-target="#myModal" title="View"
												href="${pageContext.request.contextPath}/dataEntry/viewDataEntry/${dataEntry.dataEntryId}.do"><i class="fa fa-eye" style="font-size:18px"></i></a>&nbsp;&nbsp;
												<a class="btn1" title="Edit"
												href="${pageContext.request.contextPath}/dataEntry/editDataEntryById/${dataEntry.dataEntryId}.do"><i class="fa fa-edit" style="font-size:18px"></i></a>&nbsp;&nbsp;
												<a class="btn1" title="Delete"
												href="${pageContext.request.contextPath}/dataEntry/deleteDataEntryById/${dataEntry.dataEntryId}.do"
												onclick="return confirm('Are you sure?')"><i class="fa fa-trash-o" style="font-size:18px;color:red"></i></a></td> 
									</tr>
									</c:forEach>
								</tbody>
								 <tfoot>
	...
	$(document).ready(function() {
		var oTable = $('#myDatatable').DataTable( { 
	     ...
	     //               	alert(b);
	                ...
	                // Update footer
	                 $( api.column( list[i] ).footer() ).html(''+pageTotal);
	                } 
            }
		    });
