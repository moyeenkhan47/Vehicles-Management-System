...
<!-- 	<h3 style="text-align:center;"> Search Results</h3> -->
		...
		action="${pageContext.request.contextPath}/upload/submitFile.do"> --%>    	
			...
			<tbody>
				<c:forEach items="${applicantList}" var="app" varStatus="idx">
					<tr>
						<%-- <td>
						...
						<td><c:out value="${app.createdBy}" /></td>
						<td><c:out value="${app.branch}" /></td>
						<td><c:out value="${app.createdDate}" /></td>
         ...
         dateStyle = "medium" value = "${file.uploadDate}" pattern="d MMM y" /></td> 
						...
						<td>
						<a class="btn btn-primary" href="${pageContext.request.contextPath}/print/viewApplicant/${app.applicantID}.do">View Details</a>&nbsp;&nbsp;						
