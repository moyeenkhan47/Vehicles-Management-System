...
<div class="tab">
  <button class="tablinks" onclick="openTab(event, 'newApp')">Upload New Application</button>
  <button class="tablinks" onclick="openTab(event, 'viewStatus');">View Status</button>  
</div>

<div id="newApp" class="tabcontent" style="display: block">
<c:if test="${sessionScope.User.userLevel=='1'}">
 <%@ include file="applicantSearch.jsp"%>
</c:if>
...
<div id="viewStatus" class="tabcontent">
  <%@ include file="applicantStatus.jsp"%>
