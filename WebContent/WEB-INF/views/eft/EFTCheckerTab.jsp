...
<div class="tab">
  <button class="tablinks" onclick="openTab(event, 'pending')">Pending Transaction</button>
  <button class="tablinks" onclick="openTab(event, 'verified');">Verified Transaction</button>  
</div>

<div id="pending" class="tabcontent" style="display: block">
 <%@ include file="pendingEFTTransaction.jsp"%>
</div>
<div id="verified" class="tabcontent">
  <%@ include file="verifiedEFTTransaction.jsp"%> 
</div>

<script>
$(document).ready(function(){				
			openTab(event, 'pending');		
	});
