...
<div class="tab">
  <button class="tablinks" onclick="openTab(event, 'fileUpload')">External Transaction Upload</button>
  <button class="tablinks" onclick="openTab(event, 'fileUploadHist');">External Transaction History</button>  
</div>

<div id="fileUpload" class="tabcontent" style="display: block">

  <%@ include file="EFTTransferUpload.jsp"%> 
</div>

<div id="fileUploadHist" class="tabcontent">
   <%@ include file="EFTList.jsp"%> 
</div>
