...
function printElement(elem) {
    ...
    $printSection.innerHTML = "<br/><br/><br/><br/><br/><br/><br/>";
...
<div>
      ...
      <div class="modal-header">
           <a class="btn btn-danger close" data-dismiss="modal" onclick="javascript:window.location.reload();">&times;</a>
        ...
        <div class = "table-responsive">
          ...
          <tr>
          <td>Rate:</td>
          <td> <i class="fa fa-inr"></i>${dataEntry.rate}</td>
          </tr>
          <%-- <tr>
          <td>Diesel:</td>
       ...
       --%>
          ...
          </td><td> <i class="fa fa-inr"></i>${exp.expenseAmount }
          </td>
          </tr>
          </c:forEach>
          <tr>          
          <td>Total:</td>
          <td> <i class="fa fa-inr"></i>${dataEntry.expense}</td>
          </tr>
          </table>
          ...
          <td>CreatedDate : <fmt:formatDate pattern = "dd-MMM-yyyy hh:mm:ss" value ="${dataEntry.getCreatedDate()}"/></td>
          </tr>
          </table>
          </div>
        </div>
      ...
      <div class="modal-footer">
          <%-- <a class="btn btn-default" href="${pageContext.request.contextPath}/dataEntry/dataEntryList.do">Close</a> --%>
