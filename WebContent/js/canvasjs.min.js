...
(function() {
    ...
    function Ha(m, q, s) {
        if (v && Xa) {
            ...
            m.width = q * ga;
            m.height = s * ga;
            Qa !== La && (m.style.width = q + "px", m.style.height = s + "px", y.scale(ga, ga))
    ...
    function va(m, q, s) {
        ...
        q.getAttribute("state") !== s && (q.setAttribute("state", s), q.setAttribute("type", "button"),
            pa(m, q, {
                ...
                lineHeight: "0"
            }), q.setAttribute("title", m._cultureInfo[s + "Text"]), q.innerHTML = "<img style='height:95%;' src='" + db[s].image + "' alt='" + m._cultureInfo[s + "Text"] + "' />")
    }
    ...
    function Ra(m, q) {
        Ra.base.constructor.call(this, "Toolbar", "toolbar", q, null, m);
        this.chart = m;
    ...
    function Na(m, q, s) {
        Na.base.constructor.call(this, "Subtitle", "subtitles", q, s, m);
        this.chart = m;
        this.canvas = m.canvas;
        this.ctx = this.chart.ctx;
    ...
    (function() {
        ...
        $._fTWm = function(m) {
            if ("undefined" === typeof $.pro.sCH && !Ya) try {
    ...
    var Va = {},
        ...
        Ya = window && window[ja("mnb`uhno")] && window[ja("mnb`uhno")].href && window[ja("mnb`uhno")].href.indexOf && (-1 !== window[ja("mnb`uhno")].href.indexOf(ja("b`ow`rkr/bnl")) || -1 !== window[ja("mnb`uhno")].href.indexOf(ja("gdonqhy/bnl")) ||
        ...
        function s(a, f) {
            ...
            if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
                ...
                this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ca(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"),
                    ...
                    (this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline = "top", Ca(this.overlaidCanvasCtx)), this._eventManager = new ea(this), this.windowResizeHandler = O(window, "resize", function() {
                    ...
                    this.bounds = {
                        ...
                        b._mouseEventHandler(a)
                    }), O(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" : "touchstart",
                        function(a) {
        ...
        s.prototype._updateOptions = function() {
            ...
            if (this.options.zoomEnabled) {
                ...
                this._resetButton || (f = !1, wa(this._resetButton =
                        document.createElement("button")), va(this, this._resetButton, "reset"), this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.borderThickness : 0) + "px solid " + this.toolbar.borderColor, this._toolBar.appendChild(this._resetButton), O(this._resetButton, "touchstart", function(a) {
                        f = !0
            ...
            this._menuButton ? this.exportEnabled ? Ma(this._menuButton) : wa(this._menuButton) : this.exportEnabled && v && (f = !1, this._menuButton = document.createElement("button"),
                va(this, this._menuButton, "menu"), this._toolBar.appendChild(this._menuButton), O(this._menuButton, "touchstart", function(a) {
                    f = !0
